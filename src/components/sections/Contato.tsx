    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center w-full">
        ...
        <a
          ...
          className="inline-flex items-center gap-3 mt-10 px-10 py-5 text-xl font-bold rounded-full transition-all duration-300 hover:scale-105"
          style={{
            background: "#25D366",
            color: "#fff",
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-6 text-lg">
          <span style={{ color: "var(--color-text-2)" }}>{contact.phone}</span>
          ...
          <span style={{ color: "var(--color-gold)", opacity: 0.5 }}>|</span>
          <span style={{ color: "var(--color-text-2)" }}>{contact.city}</span>
        </div>
      </div>
    </section>
  );
