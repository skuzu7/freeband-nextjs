...
export function AtoII_Galeria() {
  ...
  return (
    ...
    >
      <Container>
        <Eyebrow number="II">Contact sheet</Eyebrow>
        <h2
        ...
        >
          Uma seleção curada do arquivo — cada cena com sua própria paleta
          cinematográfica. Clique para ampliar.
        </p>
      </Container>
        ...
        {curatedGallery.map((img, i) => (
          ...
          >
            <CinematicImage
              ...
              quality={90}
              wrapperClassName="transition-transform duration-[900ms] ease-[var(--ease-drift)] group-hover:scale-[1.03]"
            />
            ...
            <div className="pointer-events-none absolute inset-x-5 bottom-5 flex items-end justify-between gap-3 font-mono text-[0.62rem] uppercase tracking-[0.28em] text-text opacity-0 transition-opacity duration-500 group-hover:opacity-100">
              <span className="line-clamp-1 max-w-[75%] text-text">
                {img.alt}
              </span>
